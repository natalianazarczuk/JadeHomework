...
public class AgentGateway extends Agent {
            ...
            public void action() {
                ...
                if (msg != null) {
                    ...
                    if (msg.getPerformative() == ACLMessage.QUERY_IF) { //ask the manager about clients request
                        System.out.println("Restaurant Gateway has received: " + msg.getContent());

                        ACLMessage msg2 = new ACLMessage(ACLMessage.QUERY_IF);
                        msg2.addReceiver(new AID("AgentManager", AID.ISLOCALNAME));
                        ...
                        System.out.println("Restaurant Gateway has answered the Client: " + initiation.getContent());
                        ...
                        send(response);
                        System.out.println("Restaurant Gateway has answered the Client: " + response.getContent());
                    }
                } else block();
            }
        });
