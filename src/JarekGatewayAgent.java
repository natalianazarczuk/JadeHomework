...
public class JarekGatewayAgent extends Agent {
            ...
            public void action() {
                ...
                if (msg != null) {
                    ...
                    if (msg.getPerformative() == ACLMessage.QUERY_IF) { //ask the manager about clients request
                        System.out.println("JarekGateway has received: " + msg.getContent());

                        ACLMessage msg2 = new ACLMessage(ACLMessage.QUERY_IF);
                        msg2.addReceiver(new AID("JarekManagerAgent", AID.ISLOCALNAME));
                        ...
                        System.out.println("JarekGateway has answered the Client: " + initiation.getContent());
                        ...
                        send(response);
                        System.out.println("JarekGateway has answered the Client: " + response.getContent());
                    }
                } else block();
            }
        });
