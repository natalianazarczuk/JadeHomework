...
public class IzumiManagerAgent extends Agent {
    ...
    protected void setup() {
        addBehaviour(new CyclicBehaviour() {
            ...
            public void action() {
                ...
                if (msg != null) {
                    System.out.println("IzumiManager has received: " + msg.getContent());
                    ...
                    System.out.println("IzumiManager has answered: " + reply.getContent());
                } else block();
            }
        });
    }
